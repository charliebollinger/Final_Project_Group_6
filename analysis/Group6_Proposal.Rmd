...
1. Bubble graphs animated year by year
2. Density plots of continents based on a variable
3. Heat maps of variable
4. Scatter Plots/Scatter Plots of variables with linear smoothers
5. Map Plots
